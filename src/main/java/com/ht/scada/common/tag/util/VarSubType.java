...
public enum VarSubType {
     ...
     * ******油井************
     */
    YOU_YA("油压", VarGroup.YOU_JING, VarType.YC), TAO_YA("套压", VarGroup.YOU_JING, VarType.YC),
    HUI_YA("回压", VarGroup.YOU_JING, VarType.YC), JING_KOU_WEN_DU("井口温度", VarGroup.YOU_JING, VarType.YC),
    HUI_GUAN_WEN_DU("汇管温度", VarGroup.YOU_JING, VarType.YC), QI_QING_ZHUANG_TAI("启停状态", VarGroup.YOU_JING, VarType.YX),

    /**
     * ******示功图*************
     */
    CHONG_CHENG("冲程", VarGroup.YOU_JING_SGT, VarType.YC),
    CHONG_CI("冲次", VarGroup.YOU_JING_SGT, VarType.YC),
    SHANG_XING_CHONG_CI("上行冲次", VarGroup.YOU_JING_SGT, VarType.YC),
    XIA_XING_CHONG_CI("下行冲次", VarGroup.YOU_JING_SGT, VarType.YC),
    ZUI_DA_ZAI_HE("最大载荷", VarGroup.YOU_JING_SGT, VarType.YC),
    ZUI_XIAO_ZAI_HE("最小载荷", VarGroup.YOU_JING_SGT, VarType.YC),
    WEI_YI_ARRAY("位移数组", VarGroup.YOU_JING_SGT, VarType.QT),
    ZAI_HE_ARRAY("载荷数组", VarGroup.YOU_JING_SGT, VarType.QT),
    /**
     * *****电功图***************
     */
    DIAN_LIU_ARRAY("电流数组", VarGroup.YOU_JING_DGT, VarType.QT),
    GONG_LV_ARRAY("功率数组", VarGroup.YOU_JING_DGT, VarType.QT),
    GONG_LV_YIN_SHU_ARRAY("功率因数数组", VarGroup.YOU_JING_DGT, VarType.QT),
    DIAN_GONG_TU_ARRAY("电功图数组", VarGroup.YOU_JING_DGT, VarType.QT),
    /**
     * *****电力数据************
     */
